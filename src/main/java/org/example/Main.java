...
public class Main {
    public static void main(String[] args) {
        ...
        Estanteria estanteriaZapatillas = new EstanteriaCalzado(Prioridad.MEDIA);
        Estanteria estanteriaAccesorios = new EstanteriaIndAcc(Prioridad.ALTA);

        estanteriaAccesorios.crearPosicionesEnMaximos();
        estanteriaZapatillas.crearPosicionesEnMaximos();
